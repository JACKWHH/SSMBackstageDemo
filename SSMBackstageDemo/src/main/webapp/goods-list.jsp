...
<body class="page-header-fixed">
	...
	<div class="page-container row-fluid">
					...
					<div class="portlet-body">
						...
						<div class="clearfix">
							...
							<div class="btn-group">
								 ...
								 <button id="sample_editable_1_new" class="btn green" onclick="window.location.href = 'goods-add.jsp'">
     ...
     <tr>
         ...
         <td>${list.number }      件</td>
         <td>
         <a href="findGoodsById.do?id=${list.id }">修改</a>
         <a href="deleteGoods.do?id=${list.id}" onclick="javascript:return confirm('确认删除吗？');">删除</a>
         </td>
     </tr>
     </c:forEach>
							</tbody>
